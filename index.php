	...
	<div id="page">
		...
		<aside id="colorlib-hero">
			<div class="flexslider">
				<ul class="slides">
			   	<li style="background-image: url(images/hotel-5.jpg);">
			   		...
			   		<div class="container-fluid">
			   			<div class="row">
				   			<div class="col-md-6 col-md-offset-3 col-sm-12 col-xs-12 slider-text">
				   				<div class="slider-text-inner text-center">
				   					<h2>The Best</h2>
				   					<h1>Experience Of Swimming</h1>
				   				</div>
				   			</div>
				   		</div>
			   		</div>
			   	</li>
			   	<li style="background-image: url(images/hotel-7.jpg);">
			   		<div class="overlay"></div>
...
<!--				         </div>-->
				         <div id="hotel" class="tab-pane fade in active">
						      <form method="post" class="colorlib-form" action="form.php">
				              	<div class="row">
				              	 <div class="col-md-2">
				              	 	<div class="booknow">
				                ...
				                <div class="col-md-2">
				                  <input type="submit" name="submit" id="submit" value="Check now/Book now" class="btn btn-primary btn-block">
				                </div>
				              </div>
				            </form>
						   </div>
...
<!--		</div>-->
	...
	<div id="colorlib-hotel">
			<div class="container">
				<div class="row">
					<div class="col-md-6 col-md-offset-3 text-center colorlib-heading animate-box">
						<h2>Rooms Of Our Hotel</h2>
						<p>We provide the most comfortable rooms which can meet your reuirements as per your needs.</p>
					</div>
				</div>
				<div class="row">
						...
						<div class="owl-carousel">
							<div class="item">
								<div class="hotel-entry">
									<a href="hotels.html" class="hotel-img" style="background-image: url(images/room-1.jpg);">
										<p class="price"><span>$120</span><small> /night</small></p>
									</a>
									<div class="desc">
										<p class="star"><span><i class="icon-star-full"></i><i class="icon-star-full"></i><i class="icon-star-full"></i><i class="icon-star-full"></i><i class="icon-star-full"></i></span> 700 Reviews</p>
							...
							<div class="item">
								<div class="hotel-entry">
									<a href="hotels.html" class="hotel-img" style="background-image: url(images/room-2.jpg);">
										<p class="price"><span>$130</span><small> /night</small></p>
									</a>
									<div class="desc">
										<p class="star"><span><i class="icon-star-full"></i><i class="icon-star-full"></i><i class="icon-star-full"></i><i class="icon-star-full"></i><i class="icon-star-full"></i></span> 585 Reviews</p>
							...
							<div class="item">
								<div class="hotel-entry">
									<a href="hotels.html" class="hotel-img" style="background-image: url(images/room-3.jpg);">
										<p class="price"><span>$140</span><small> /night</small></p>
									</a>
									<div class="desc">
										<p class="star"><span><i class="icon-star-full"></i><i class="icon-star-full"></i><i class="icon-star-full"></i><i class="icon-star-full"></i><i class="icon-star-full"></i></span> 600 Reviews</p>
							...
							<div class="item">
								<div class="hotel-entry">
									<a href="hotels.html" class="hotel-img" style="background-image: url(images/room-4.jpg);">
										<p class="price"><span>$150</span><small> /night</small></p>
									</a>
									<div class="desc">
						...
						<div class="owl-carousel2">
							<div class="item">
								<div class="testimony text-center">
									<span class="img-user" style="background-image: url(images/aavash.jpg);"></span>
									<span class="user">Aavash Chaudary</span>
									<small>Satdobato, KTM</small>
									<blockquote>
										<p>I found myself the luckiest person to enjoy the services provided by Landmark.  </p>
									</blockquote>
								</div>
							</div>
							<div class="item">
								<div class="testimony text-center">
									<span class="img-user" style="background-image: url(images/sujan.jpg);"></span>
									<span class="user">Sujan Phuyal</span>
									<small>New York, USA</small>
									<blockquote>
										<p>One day i'm gonna revisit this hotel with my wife and children. </p>
									</blockquote>
								</div>
							</div>
							<div class="item">
								<div class="testimony text-center">
									<span class="img-user" style="background-image: url(images/sangeet.jpg);"></span>
									<span class="user">Sangeet Godar</span>
									<small>Baneswor, KTM</small>
									<blockquote>
										<p>THe tales of this hotel should not be bind in words but should becomes a tale to the future. </p>
									</blockquote>
								</div>
							</div>
						</div>
...
<!--					</div>-->
					...
					<div class="col-md-3 col-md-push-1">
						...
						<ul class="colorlib-footer-links">
							<li> Sallaghari, Bhaktapur</li>
							<li><a href="tel://1234567920">+9779816989437</a></li>
							<li><a href="mailto:info@yoursite.com">landmark@gmail.com</a></li>
							<li><a href="#">www.landmark.com</a></li>
						</ul>
					</div>
				</div>
				<div class="row">

				...
				<div class="row">
					...
					<div class="col-md-5 col-md-pull-7">
						<div class="booking-form">
							<form method="post" name="reservation" onsubmit="return validate()" action="reserved.php">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-sm-6">
                                        <div class="form-group">
                                            ...
                                            <input name="phone" id="phone" class="form-control" placeholder="Enter phone number" type="phone" required>
                                        </div>
                                    </div>
                                </div>
								<div class="form-btn">
...
<script type="text/javascript">
	function validate() 
	{
		var phn = document.reservation.phone.value;

		var phnPattern = /^([9][0-9]{9})$/;
    //Phone validator
    if (phn == "") {
        document.getElementById("phnMsg").innerHTML = "Enter your phone number";
        error = true;
    } else if (!phnPattern.test(phn)) {
        document.getElementById("phnMsg").innerHTML = "Enter your phone number pattern";
        error = true;
    } else {
